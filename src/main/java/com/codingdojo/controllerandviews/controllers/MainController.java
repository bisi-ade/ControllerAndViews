package com.codingdojo.controllerandviews.controllers;
 ...
 // display login page
    ...
    public String loginUser(
    	...
    	if(this.userService.authenticateUser(email, password)) {
    		User loggedInUser = this.userService.getUserByEmail(email);
    ...
    public String showHomePage(HttpSession session, Model model) {
    	...
    	User user = userService.getUserById(userId);//save them in the model
